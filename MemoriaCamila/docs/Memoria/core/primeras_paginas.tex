...
\end{minipage}};
% Text Node
\draw (200,200) node [anchor=north west][inner sep=0.4pt]  [font=\LARGE] [align=left] {\begin{minipage}[lt]{300pt}\setlength\topsep{0pt}
\begin{center}
\titulo
\end{center}
...
\begin{center}
TRABAJO PARA OPTAR AL TITULO\\ DE INGENIERO CIVIL EN CIENCIAS DE LA COMPUTACIÓN
\end{center}
...
% Genera agradecimientos leyendo definicion de agradecimientos
  ...
  \newpage \addcontentsline{toc}{section}{Agradecimientos}
